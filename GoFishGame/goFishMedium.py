...
#This program creates a simulation of a game of Go Fish by creating a
    #GoFish class.  The computer has a memory of 4 requests.
...
class GoFishMedium:
    ...
    def memoryMedium(self):
        """Remembers the previous 4 requests of the player."""
        temp2=self.mem1
        temp3=self.mem2
        self.mem1=self.mem0
        self.mem2=temp2
        ...
        self.memory=[self.mem0,self.mem1,self.mem2,self.mem3]
        print(self.memory)
        return self.memory
